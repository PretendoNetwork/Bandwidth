...
module.exports = {
	...
	'0101': new SupportCode('Missing name', 'Game server is under maintenance', 'Either the network is experiencing high\ntraffic volumes or the service is down.\nPlease try again later.\n\nFor help, visit support.nintendo.com', 'Missing fix', 'Missing link'),
	...
	'0111': new SupportCode('Missing name', 'Missing description', 'The online service is unavailable.\nPlease try again later.\n\nFor help, visit support.nintendo.com', 'Missing fix', 'Missing link'),
	'0112': new SupportCode('Missing name', 'SVC is invalid', 'Missing message', 'Missing fix', 'Missing link'),
	...
	'0127': new SupportCode('Missing name', 'Key hash is invalid', 'Missing message', 'Missing fix', 'Missing link'),
	'0150': new SupportCode('Custom Pretendo Error', 'Serial number mismatch', 'Missing message', 'Revert your original serial or report the issue', 'Missing link'),
	'0151': new SupportCode('Custom Pretendo Error', 'Error when registering new account', 'Missing message', 'Try again later', 'Missing link'),
	'3500': new SupportCode('Missing name', 'HTTP Error 500', 'Missing message', 'Missing fix', 'Missing link'),
	'3501': new SupportCode('Missing name', 'HTTP Error 501', 'Missing message', 'Missing fix', 'Missing link'),
	'3502': new SupportCode('Missing name', 'HTTP Error 502', 'Missing message', 'Missing fix', 'Missing link'),
	'3503': new SupportCode('Missing name', 'HTTP Error 503', 'The server is currently undergoing\nmaintenance. We apologize for any\ninconvenience. Please try again later.\n\nTo learn more about maintenance,\nvisit support.nintendo.com', 'Missing fix', 'Missing link'),
	'3504': new SupportCode('Missing name', 'HTTP Error 504', 'Missing message', 'Missing fix', 'Missing link'),
};
